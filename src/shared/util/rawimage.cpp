...
//     if (data != nullptr)
//     {
//         // Assuming the image format is RGB (you may need to adjust accordingly)
//         cv::Mat output_mat(height, width, CV_8UC3, data);
//         cv::imwrite(filename, output_mat);
//     }
//     else
//     {
//         // Handle the case when there is no image data
//         std::cerr << "Error: Image data is null. Cannot save to file." << std::endl;
//     }
// }
